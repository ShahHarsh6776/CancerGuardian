...
class CancerDataset(Dataset):
    def __init__(self, data_dir, transform=None):
        ...
        # Order matters: benign (0) = non-skin cancer, malignant (1) = skin cancer
            ...
            if os.path.exists(class_dir):
                for img_name in os.listdir(class_dir):
                    if img_name.endswith(('.jpg', '.jpeg', '.png')):
                        ...
                        # class_idx will be 0 for benign (non-skin cancer) and 1 for malignant (skin cancer)
...
class CancerDetectionModel(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(512, 2)  # 2 classes: benign and malignant
...
def main():
    ...
    # Create datasets
    train_dir = "dataset/benign"  # Path to training data
    val_dir = "dataset/malignant"      # Path to validation data
