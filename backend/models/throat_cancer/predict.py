...
def main():
    ...
    if not image_path:
        image_path = "D:/Cancer_Model/zip/dataset/train/benign/127.jpeg"
        print(f"Using default image: {image_path}")
    
    # Get model path from user
    print("\nEnter the path to your model (e.g., path/to/your/model.h5):")
    print("Note: Do not include quotes around the path")
    ...
    if not model_path:
        model_path = "D:/Cancer_Model/zip/dataset/train/benign/127.jpeg"
